...
<head>
    ...
    <title><?= esc($title ?? 'Formulir Laporan Kematian'); ?></title>
    ...
    <style>
        ...
        * {
        ...
        .form-select:focus {
            border-color: #9ca3af;
            box-shadow: 0 0 0 0.18rem rgba(38, 49, 60, 0.13);
        }
    ...
    <div class="main-container">
        ...
        <div class="card form-card">
            <div class="card-header">
                <h5>Formulir Laporan Kematian Warga</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('pkk/kematian/store'); ?>" method="post">
                    <?= csrf_field(); ?>

                    <div class="mb-3 autocomplete-wrap">
                        <label class="form-label">NIK / Nama Warga yang Wafat</label>
                        <input type="text"
                               name="nik"
                               id="nik_input"
                               class="form-control"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan"
                                  class="form-control"
                                  rows="4"
                                  placeholder="Contoh: Sakit tua, sakit jantung, kecelakaan"><?= esc(old('keterangan')); ?></textarea>
                    </div>
                    ...
                    <div class="action-row">
                        ...
                        <button type="submit" class="btn btn-dark-custom btn-action">Simpan Laporan</button>
                    </div>
                </form>
