...
<head>
    ...
    <title><?= esc($title ?? 'Edit Riwayat Kelahiran'); ?></title>
...
<?php
    ...
    $nikIbu = old('nik_ibu', $kelahiran['nik_ibu'] ?? '');
    $namaBayi = old('nama_bayi', $kelahiran['nama_bayi'] ?? '');
    $jenisKelamin = old('jenis_kelamin', $kelahiran['jenis_kelamin'] ?? '');
    $tglLahir = old('tgl_lahir', $kelahiran['tgl_lahir'] ?? '');
    $tempatLahir = old('tempat_lahir', $kelahiran['tempat_lahir'] ?? '');
    $keterangan = old('keterangan', $kelahiran['keterangan'] ?? '');
?>
    ...
    <div class="main-container">
        ...
        <div class="card form-card">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('pkk/kelahiran/update/' . rawurlencode((string) $idKelahiran)); ?>" method="post">
                    <?= csrf_field(); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan"
                                  class="form-control"
                                  rows="4"
                                  placeholder="Contoh: Lahir di RS Daerah, ditolong oleh bidan."><?= esc($keterangan); ?></textarea>
                    </div>

                    <div class="divider"></div>

                    <div class="action-row">
                        <a href="<?= base_url('pkk/kelahiran'); ?>" class="btn btn-light-custom btn-action">Batal</a>
