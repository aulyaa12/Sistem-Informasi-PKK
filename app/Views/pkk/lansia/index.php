...
<head>
    ...
    <title><?= esc($title ?? 'Data Lansia'); ?> | Sistem Informasi PKK</title>
...
<?php
    $menus = [
        ...
        ['url' => 'pkk/lansia', 'icon' => 'bi-person-standing', 'label' => 'Data Lansia', 'active' => true],
    ...
    <div class="content">
        <main class="main">
            ...
            <div class="page-title">
                <div>
                    <h1>Data Lansia</h1>
                    <p>Kelola data pemantauan lansia berdasarkan wilayah akun yang sedang digunakan.</p>
                </div>
                            ...
                            <?php else : ?>
                                <?php foreach ($lansia as $row) : ?>
                                    <?php
                                        ...
                                        $umurValue = $row['umur'] ?? ($row['umur_lansia'] ?? '');
                                        $umur = $umurValue !== '' ? $umurValue . ' Tahun' : '-';
                                        ...
                                        $produktivitasLower = strtolower(trim((string) $produktivitas));
                                        $isProduktif = $produktivitasLower === 'produktif';
                                    ?>
